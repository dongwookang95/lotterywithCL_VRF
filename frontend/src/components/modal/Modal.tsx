const Modal = ({callback,open, setModalIsOpen}:{callback:any, open:any,setModalIsOpen:any}) => {
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gray-700 bg-opacity-50">
                    <div className="max-w-sm p-6 bg-[#0F0E13] divide-y divide-gray-500 text-white">
                        <div className="flex items-center justify-between">
                            ...
                            <svg className="cursor-pointer" onClick={()=>{setModalIsOpen(false)}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
